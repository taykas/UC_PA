...
function App() {
  return (
    <>
      <Router>
      <nav>
        <Link to="/">Exercicio 1</Link> | <Link to="/Exercicio2">Exercicio 2</Link> | <Link to="/Exercicio3">Exercicio 3</Link> | <Link to="/Exercicio4">Exercicio 4</Link> | <Link to="/Exercicio5">Exercicio 5</Link>
      </nav>
